...
module EFTCAMB_cache
    ...
    type, extends(TCambComponent) :: TEFTCAMB_timestep_cache
        ...
        real(dl) :: delta_phi       !< the value of the delta_phi field at a given time and scale.
        real(dl) :: delta_phidot    !< the value of the (conformal) time derivative of the delta_phi field at a given time and scale.
        real(dl) :: delta_phidotdot !< the value of the (conformal) second time derivative of the delta_phi field at a given time and scale.
