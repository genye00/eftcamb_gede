...
contains
    ...
    contains
        ...
        subroutine output( num_eq, ind, x, y )
            ...
            write(*,*) 'a, rho_tot, H2, phi, phi_prime, V, V0', a, grho_matter/a2, H2/a2, phi, phi_prime*sqrt(H2), 3._dl*(1._dl-omega_m)*params_cache%h0_Mpc**2*self%quintessence_potential(phi,deriv=0), 3._dl*(1._dl-omega_m)*params_cache%h0_Mpc**2
