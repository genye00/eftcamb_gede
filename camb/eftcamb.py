...
class EFTCAMB(F2003Class):
    ...
    _fields_ = [
               ...
               # delta_phi flags
               ("EFT_evolve_delta_phi ", c_bool, "Flag that decides whether integrate delta_phi instead of pi for covariant theories"),
               ("EFT_evolve_metric_h ", c_bool, "Flag that decides whether integrate h' instead of using constraints"),
               ("EFT_skip_stability ", c_bool, "Flag that decides whether skip all stability checks."),
               # Stability flags
...
class EFTCAMB_timestep_cache(F2003Class):
    ...
    _fields_ = [
                ...
                ("delta_phi", c_double),
                ("delta_phidot", c_double),
                ("delta_phidotdot", c_double),
